        ...
        <div className="container-fluid">
          ...
          <div className="collapse navbar-collapse" id="navbarNav">
            <ul className="navbar-nav ms-auto fw-bold fs-6">
              ...
              <li className="nav-item">
                <Link to={'/InvoiceDetailTable'} className="nav-link" ><span className="svg-icon svg-icon-light svg-icon-1"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
              ...
              <li className="nav-item">
                <Link to={'/Settings'} className="nav-link"><span className="svg-icon svg-icon-light svg-icon-1"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
