            ...
            ? <div className="collapse navbar-collapse" id="navbarNav">
              <ul className="navbar-nav ms-auto fw-bold fs-6">
                <li className="nav-item">
                  <NavLink to={'/Home'} className="nav-link " ><span className="svg-icon svg-icon-light svg-icon-1"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <li className="nav-item">
                  <NavLink to={'/InvoiceDetailTable'} className="nav-link" ><span className="svg-icon svg-icon-light svg-icon-1"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <li className="nav-item">
                  <NavLink to={'/UserManagement'} className="nav-link" ><span className="svg-icon svg-icon-light svg-icon-1"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <li className="nav-item">
                  <NavLink to={'/WorkFlow'} className="nav-link">
                    <span className="svg-icon svg-icon-light svg-icon-1"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <li className="nav-item">
                  <NavLink to={'/Settings'} className="nav-link"><span className="svg-icon svg-icon-light svg-icon-1"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
